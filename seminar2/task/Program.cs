...
// int[] a = new int[16]; 
// int q = a.Length;
// for (int i = 0; i < 100; i++)// Заполнили массив 
// {
//     int a = i++;
...
for (int i = 1; i < 101; i++)// Заполнили массив 
{
    //int a = i;
    if (i % 3 == 0 && i % 5 == 0) // Проверяем кратность и 3 и 5)
    {
        Console.Write("FizzBuzz,");
    }
    else if (i % 5 == 0)    // Проверяем кратность 5)
    {
        Console.Write("Buzz,");
    }
    else if (i % 3 == 0)    // Проверяем кратность 3)
    {
        Console.Write("Fizz,");
    }
    else
